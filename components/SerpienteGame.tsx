...
import {
  createSerpienteGame,
  type SerpienteHandle,
} from "@/lib/games/serpiente";
...
export default function SerpienteGame({ game }: SerpienteGameProps) {
  const user = useStoredUser();
  const canvasRef = useRef<HTMLCanvasElement>(null);
  const handleRef = useRef<SerpienteHandle | null>(null);
  ...
  useEffect(() => {
    ...
    handleRef.current = createSerpienteGame(canvas, (score) => {
      setFinalScore(score);
      setOver(true);
    });
